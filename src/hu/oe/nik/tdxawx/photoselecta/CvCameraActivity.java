...
public class CvCameraActivity extends Activity implements /*OnTouchListener,*/ CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    //mOpenCvCameraView.setOnTouchListener(CvCameraActivity.this);
                } break;
                default:
                {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        //Scalar greenish = new Scalar(110,255,80,255);
        //Scalar greenish_hsv = convertScalarRgba2Hsv(greenish);
        //mDetector.setHsvColor(greenish_hsv);
    }
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
    	mDetector.setColorRadius(new Scalar(25,205,155));
    	mDetector.setHsvColor(new Scalar(75,255,255));

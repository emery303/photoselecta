...
public class DraggableGridView extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
    ...
    protected OnTouchListener secondaryOnTouchListener;
    protected OnTouchListener onTouchEnd;
    protected OnTouchListener onDeleteHover;
    ...
    public void setOnTouchListener(OnTouchListener l) {
    	secondaryOnTouchListener = l;
    }
    public void setTouchEndListener(OnTouchListener l) {
    	onTouchEnd = l;
    }
    public void setDeleteHoverListener(OnTouchListener l) {
    	onDeleteHover = l;
    }
    ...
    public void removeViewAt(int index) {
    	enabled = false;
    	touching = false;
    	String photo_path = this.photoPaths.get(index);
    	DatabaseManager db = new DatabaseManager(getContext());
    	db.deletePhotoByPath(photo_path);
    	db.CloseDB();
    	this.photoPaths.remove(index);
        ...
        int action = event.getAction();
           switch (action & MotionEvent.ACTION_MASK) {
               case MotionEvent.ACTION_DOWN:
                   ...
                   if (index != -1)
                   {
                	   if (secondaryOnTouchListener != null) {
                		   secondaryOnTouchListener.onTouch(view, event);
                	   }
                       dragged = index;
                       animateDragged();
                       return true;
               ...
               case MotionEvent.ACTION_MOVE:
            	   if (enabled) {
	                   ...
	                   lastY = (int) event.getY();
	                   lastDelta = delta;
	                   if (onDeleteHover != null) {
	                	   onDeleteHover.onTouch(view, event);
	            	   }
            	   }
                   break;
